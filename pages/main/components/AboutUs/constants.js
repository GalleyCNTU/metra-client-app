...
export const BOTTOM_ITEMS = [
    {
        ...
        subtitle: "Наш оцінник приїде у зручне для вас місце та час для абсолютно безкоштовної оцінки вашого авто"
    },
    {
        svg: payments,
        title: "Пропонуємо найкращу ціну",
        subtitle: "Ми постійно перевіряємо ціни конкурентів i пропонуємо найкращу пропозицію"
    },
    {
        svg: approval_delegation,
        title: "Допомога при оформленні",
        subtitle: "При оформленні угоди ви можете розраховувати на консультацію нашого фахівця з продажу"
    },
    {
        svg: schedule,
        title: "Виплати за авто від 30 хв.",
        subtitle: "Ви отримаєте гроші від 30хв. після документального оформлення угоди i переоформлення авто"
    },
]