...
const BuyingInfo = () => {
    return (
        <div className='buying_info'>
            <div className='buying_info_background'>
                <img src={arrow} alt="" />
            </div>
            <div className="buying_info_header">
                <span className="buying_info_header title">
                    ЯК ВІДБУВАЄТЬСЯ
                    <br />
                    ВИКУП АВТО?
                </span>
            </div>
            <div className="buying_info_row">
                <div className="buying_info_column">
                    <div className="item-buying_info_number">
                    ...
                    <div className="item-buying_info_title">
                        <span>Дзвінок <br />або заявка</span>
                    </div>
                    <div className="item-buying_info_text">
                ...
                <div className="item-buying_info_arrow">
